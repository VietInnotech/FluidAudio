...
swift run fluidaudiocli whisper-benchmark --max-files 50 --model-dir Models/whisperkit-coreml/openai_whisper-large-v3_turbo

# Whisper with a specific language
swift run fluidaudiocli whisper-benchmark --max-files 20 --language fr --model-dir Models/whisperkit-coreml/openai_whisper-large-v3_turbo

# Vietnamese CTC transcription
swift run fluidaudiocli ctc-transcribe audio.wav

# Vietnamese Zipformer transcription
swift run fluidaudiocli zipformer-transcribe audio.wav
```
